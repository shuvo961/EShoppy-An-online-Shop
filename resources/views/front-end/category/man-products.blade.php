            ...
            <div class="col-md-8 products-right">
                ...
                <div class="men-wear-top">
                    ...
                    <div  id="top" class="callbacks_container">
                        <ul class="rslides" id="slider3">
                            <li>
                                <img class="img-responsive" src="{{asset('/')}}/front-end/images/banner2.jpg" alt=" "/>
                            </li>
                            <li>
                                <img class="img-responsive" src="{{asset('/')}}/front-end/images/banner5.jpg" alt=" "/>
                            </li>
                            <li>
                                <img class="img-responsive" src="{{asset('/')}}/front-end/images/banner2.jpg" alt=" "/>
                            </li>
                ...
                <div class="men-wear-bottom">
                    <div class="col-sm-4 men-wear-left">
                        <img class="img-responsive" src="{{asset('/')}}/front-end/images/bb2.jpg" alt=" " />
                    </div>
                ...
                <div class="col-md-4 product-men">
                    <div class="men-pro-item simpleCart_shelfItem">
                        <div class="men-thumb-item">
                            <img src="{{asset($categoryProduct->product_image)}}" alt="" class="pro-image-front">
                            <img src="{{asset($categoryProduct->product_image)}}" alt="" class="pro-image-back">
                            <div class="men-cart-pro">
                                <div class="inner-men-cart-pro">
                                    <a href="{{route("single-product",['id'=>$categoryProduct->id,'name'=>$categoryProduct->product_name])}}" class="link-product-add-cart">Quick View</a>
                                </div>
                            </div>
                        ...
                        <div class="item-info-product ">
                            <h4><a href="{{route("single-product",['id'=>$categoryProduct->id,'name'=>$categoryProduct->product_name])}}">{{$categoryProduct->product_name}}</a></h4>
                            <div class="info-product-price">
                                <span class="item_price">Tk.{{$categoryProduct->product_price}}</span>
                                <del>Tk.{{$categoryProduct->product_price + 50}}</del>
                            </div>
            ...
            <div class="col-md-9 footer-right">
                <div class="sign-grds">
                    ...
                    <div class="col-md-3 sign-gd flickr-post">
                        ...
                        <ul>
                            <li><a href="{{route("single-product",['id'=>$categoryProduct->id,'name'=>$categoryProduct->product_name])}}"><img src="{{asset('/')}}/front-end/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="{{route("single-product",['id'=>$categoryProduct->id,'name'=>$categoryProduct->product_name])}}"><img src="{{asset('/')}}/front-end/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="{{route("single-product",['id'=>$categoryProduct->id,'name'=>$categoryProduct->product_name])}}"><img src="{{asset('/')}}/front-end/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="{{route("single-product",['id'=>$categoryProduct->id,'name'=>$categoryProduct->product_name])}}"><img src="{{asset('/')}}/front-end/images/t4.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="{{route("single-product",['id'=>$categoryProduct->id,'name'=>$categoryProduct->product_name])}}"><img src="{{asset('/')}}/front-end/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="{{route("single-product",['id'=>$categoryProduct->id,'name'=>$categoryProduct->product_name])}}"><img src="{{asset('/')}}/front-end/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="{{route("single-product",['id'=>$categoryProduct->id,'name'=>$categoryProduct->product_name])}}"><img src="{{asset('/')}}/front-end/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="{{route("single-product",['id'=>$categoryProduct->id,'name'=>$categoryProduct->product_name])}}"><img src="{{asset('/')}}/front-end/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
