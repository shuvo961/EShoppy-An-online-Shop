            ...
            <div class="col-md-8 products-right">
                ...
                <div class="men-wear-top">
                    ...
                    <div  id="top" class="callbacks_container">
                        <ul class="rslides" id="slider3">
                            <li>
                                <img class="img-responsive" src="{{asset('/')}}/front-end/images/banner4.jpg" alt=" "/>
                            </li>
                            <li>
                                <img class="img-responsive" src="{{asset('/')}}/front-end/images/banner3.jpg" alt=" "/>
                            </li>
                            <li>
                                <img class="img-responsive" src="{{asset('/')}}/front-end/images/banner1.jpg" alt=" "/>
                            </li>
                ...
                <div class="men-wear-bottom">
                    <div class="col-sm-4 men-wear-left">
                        <img class="img-responsive" src="{{asset('/')}}/front-end/images/bb1.jpg" alt=" " />
                    </div>
            ...
            <div class="col-md-9 footer-right">
                <div class="sign-grds">
                    ...
                    <div class="col-md-3 sign-gd flickr-post">
                        ...
                        <ul>
                            <li><a href="single.html"><img src="{{asset('/')}}/front-end/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="single.html"><img src="{{asset('/')}}/front-end/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="single.html"><img src="{{asset('/')}}/front-end/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="single.html"><img src="{{asset('/')}}/front-end/images/t4.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="single.html"><img src="{{asset('/')}}/front-end/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="single.html"><img src="{{asset('/')}}/front-end/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="single.html"><img src="{{asset('/')}}/front-end/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
                            <li><a href="single.html"><img src="{{asset('/')}}/front-end/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
