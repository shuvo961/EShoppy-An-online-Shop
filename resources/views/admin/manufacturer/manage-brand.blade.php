            ...
            <div class="col-sm-11 mx-auto my-auto">
                <div class="panel panel-default border-0">
                    <div class="panel-heading py-lg-3">
                        <h5 class="text-dark  text-uppercase" align="center">Manage - Brand</h5>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center m-0 p-0">
                                        @if($manufacturer->publication_status==1)
                                            <a href="{{route('unpublished-brand', ['id'=>$manufacturer->id])}}" class="btn btn-warning btn-xs">
                                                <span> <i class="fa fa-arrow-down" aria-hidden="true"></i></span>
                                            </a>
                                        @else()
                                            <a href="{{route('published-brand', ['id'=>$manufacturer->id])}}" class="btn btn-info btn-xs">
                                                <span> <i class="fa fa-arrow-up" aria-hidden="true"></i></span>
                                            </a>
                                        @endif
                                        <a href="{{route('edit-brand', ['id'=>$manufacturer->id])}}" class="btn btn-success btn-xs">
                                            <span> <i class="fa fa-edit" aria-hidden="true"></i></span>
                                        </a>
                                        <a href="{{route('delete-brand', ['id'=>$manufacturer->id])}}" class="btn btn-danger btn-xs">
